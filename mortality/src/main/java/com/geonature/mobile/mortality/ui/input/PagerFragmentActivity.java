package com.geonature.mobile.mortality.ui.input;
...
import com.geonature.mobile.commons.input.SaveInputAsyncTask;
...
import com.geonature.mobile.mortality.input.Input;
import com.geonature.mobile.mortality.ui.input.comments.AdditionalInformationFragment;
import com.geonature.mobile.mortality.ui.input.counting.SimpleCountingListFragment;
import com.geonature.mobile.mortality.ui.input.map.WebViewFragment;
import com.geonature.mobile.mortality.ui.input.observers.ObserversAndDateFragment;
import com.geonature.mobile.mortality.ui.input.results.ResultsInputFragment;
import com.geonature.mobile.mortality.ui.input.taxa.TaxaFragment;
...
public class PagerFragmentActivity
    ...
    protected Map<Integer, IValidateFragment> getPagerFragments() {
        ...
        fragments.put(R.string.pager_fragment_counting_title,
                      new SimpleCountingListFragment());
        fragments.put(R.string.pager_fragment_additional_information_title,
                      new AdditionalInformationFragment());
