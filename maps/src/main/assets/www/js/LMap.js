L.MapControl = L.Class.extend(
{
	...
	initialize: function(options)
	{
		...
		this.options.maxBounds = new L.LatLngBounds([maxBounds[0][0], maxBounds[0][1]], [maxBounds[1][0], maxBounds[1][1]]);
		...
		var maxResolution = Math.max(this.options.bbox[2] - this.options.bbox[0], this.options.bbox[3] - this.options.bbox[1]) / 256;
		...
		var crs = new L.Proj.CRS("EPSG:2154","+proj=lcc +lat_1=49 +lat_2=44 +lat_0=46.5 +lon_0=3 +x_0=700000 +y_0=6600000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs",
		{
			...
			transformation: new L.Transformation(1, -this.options.bbox[0], -1, this.options.bbox[3])
		});
