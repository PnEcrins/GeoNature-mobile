...
* `dir` : Permet de lire les tuiles directement sur l'espace de stockage du terminal selon un
...
Contrôleur générique permettant d'ajouter une couche de données supplémentaire sur la carte à partir
