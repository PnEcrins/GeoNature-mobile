...
public class SearchDialogFragment
    ...
    public static SearchDialogFragment newInstance(
        ...
        if (BuildConfig.DEBUG) {
            Log.d(
                    SearchDialogFragment.class.getName(),
                    "newInstance"
            );
        }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(getActivity()).setTitle(R.string.alert_dialog_search_title)
                .setView(view)
                .setPositiveButton(
                        ...
                        new OnClickListener() {
                            ...
                            public void onClick(
                                    ...
                                    int which) {
                                mOnSearchDialogValidateListener.onSearchCriteria(
                                        dialog,
        ...
        textViewSearchRadius.setText(
                String.format(
                        getString(R.string.alert_dialog_search_radius),
                        getArguments().getInt(KEY_MIN_RADIUS)
                )
        );
        textViewSeekBarMinValue.setText(
                String.format(
                        getString(R.string.alert_dialog_search_radius_meters),
                        getArguments().getInt(KEY_MIN_RADIUS)
                )
        );
        textViewSeekBarMaxValue.setText(
                String.format(
                        getString(R.string.alert_dialog_search_radius_meters),
        ...
        seekBarSearchRadius.setOnSeekBarChangeListener(
