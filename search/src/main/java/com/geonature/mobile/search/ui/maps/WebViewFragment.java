...
import com.geonature.mobile.maps.AbstractWebViewFragment;
import com.geonature.mobile.maps.control.AbstractControl.OnIControlListener;
import com.geonature.mobile.maps.control.CenterPositionControl;
import com.geonature.mobile.maps.control.ControlUtils;
import com.geonature.mobile.maps.control.FeaturesControl;
import com.geonature.mobile.maps.control.SwitchLayersControl;
import com.geonature.mobile.maps.control.ZoomControl;
import com.geonature.mobile.maps.jts.geojson.Feature;
import com.geonature.mobile.maps.jts.geojson.FeatureStyle;
...
import com.geonature.mobile.search.content.LoadFilteredFeaturesLoader;
import com.geonature.mobile.search.content.MainContentProvider;
...
public class WebViewFragment
    ...
    public void onPause() {
        ...
        getLoaderManager().destroyLoader(LOADER_TAXA_GROUPBY);
        getLoaderManager().destroyLoader(LOADER_TAXA);
    }
