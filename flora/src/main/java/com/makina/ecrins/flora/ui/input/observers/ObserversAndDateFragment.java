...
import com.makina.ecrins.flora.ui.observers.ObserversFragmentActivity;
 ...
 */
public class ObserversAndDateFragment extends AbstractObserversAndDateFragment {
    ...
    public Map<Long, Observer> getSelectedObservers() {
        return ((MainApplication) getActivity().getApplication()).getInput().getObservers();
    }

    @Override
    public Date getSelectedDate() {
        return ((MainApplication) getActivity().getApplication()).getInput().getDate();
    }

    @Override
    public void updateSelectedDate(Date pDate) {
        ((MainApplication) getActivity().getApplication()).getInput().setDate(pDate);
    }
