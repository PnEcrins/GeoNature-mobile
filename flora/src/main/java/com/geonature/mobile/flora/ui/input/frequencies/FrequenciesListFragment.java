package com.geonature.mobile.flora.ui.input.frequencies;
...
import com.geonature.mobile.flora.ui.frequencies.FrequencyFragmentActivity;
...
public class FrequenciesListFragment
    ...
    public void refreshView() {
        ...
        if (getListAdapter() == null) {
            ...
            adapter.add(new Frequency(Frequency.FrequencyType.ESTIMATION));
            adapter.add(new Frequency(Frequency.FrequencyType.TRANSECT));
